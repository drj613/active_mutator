  ...
  module CLI
    ...
    def self.parse(argv)
      options = {
        ...
        diagnostics: false, events_file: nil, sample_interval: 5.0
      }
      ...
      paths = OptionParser.new do |o|
        ...
        o.on("--sample-interval S", Float, "Seconds between memory samples with --diagnostics/--events (default: 5)") do |v|
